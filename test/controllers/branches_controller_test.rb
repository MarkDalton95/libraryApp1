...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { address: @branch.address, branch_image: @branch.branch_image, closing_time: @branch.closing_time, opening_time: @branch.opening_time }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { address: @branch.address, branch_image: @branch.branch_image, closing_time: @branch.closing_time, opening_time: @branch.opening_time }
    assert_redirected_to branch_path(assigns(:branch))
  end
